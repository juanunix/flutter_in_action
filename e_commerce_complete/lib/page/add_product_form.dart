...
import 'package:e_commerce_complete/widget/forms/input_dropdown.dart';
...
class _AddProductFormState extends State<AddProductForm> {
  /// ****************
  /// Widget Set Up Region
  /// Doesn't have to do with Form Lesson
  ///
  UserBloc _userBloc;
  CatalogBloc _bloc;
  @override
  void didChangeDependencies() {
    ...
    _userBloc = AppState.of(context).blocProvider.userBloc;
