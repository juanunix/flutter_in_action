...
import 'package:e_commerce_start_chapter_8/blocs/app_state.dart';
...
import 'package:e_commerce_start_chapter_8/page/base/page_container.dart';
import 'package:e_commerce_start_chapter_8/utils/material_route_transition.dart';
import 'package:e_commerce_start_chapter_8/utils/styles.dart';
import 'package:e_commerce_start_chapter_8/widget/add_to_cart_bottom_sheet.dart';
import 'package:e_commerce_start_chapter_8/widget/product_detail_card.dart';
...
class CatalogState extends State<Catalog> {
  ...
  void didChangeDependencies() {
    ...
    slivers = [];
    _bloc = AppStateManager.of(context).blocProvider.catalogBloc;
  }
  ...
  void _showQuickAddToCart(BuildContext context, Product product) async {
    var _cartBloc = AppStateManager.of(context).blocProvider.cartBloc;
