...
class AppBarCartIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    /// TODO chapter 8: Uncomment after finishing Inherited Widget
//    var _bloc = AppStateManager.of(context).blocProvider.cartBloc;
    return Padding(
        ...
        children: <Widget>[
          ...
          new Positioned(
            ...
            child: new Container(
              ...
              ///
              /// TODO chapter 8: Revert after InheritedWidget section
              ///
              child: Text(
                "", // TODO chapter 8: use inherited widget
                style: new TextStyle(fontSize: 8.0, color: Colors.white),
                textAlign: TextAlign.center,
              ),
                ///
                /// TODO: Uncomment and remove above Text Widget
                ///
//              child: StreamBuilder(
//                initialData: 0,
